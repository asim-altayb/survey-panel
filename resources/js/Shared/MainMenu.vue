<template>
  <div>
    ...
    <div class="mb-4">
      <Link class="group flex items-center py-3" href="/surveys">
        <icon name="office" class="mr-2 w-4 h-4" :class="isUrl('surveys') ? 'fill-white' : 'fill-indigo-400 group-hover:fill-white'" />
        <div :class="isUrl('surveys') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">Surveys</div>
      </Link>
    </div>
    <div class="mb-4">
